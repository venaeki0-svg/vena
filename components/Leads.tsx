                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-center mt-3">
                                        ...
                                        {lead.status === LeadStatus.FOLLOW_UP && (
                                            <button onClick={(e) => { e.stopPropagation(); handleFollowUpClick(lead);}} className="p-1.5 bg-brand-input rounded-full text-brand-accent hover:bg-brand-accent/20"><SendIcon className="w-4 h-4"/></button>
                                        )}
                                    </div>
                                </div>
                            ))}
